      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-6">
            <p>This is just some examples of what your church can do with the B1 Church mobile app.  You can also embed any web page you wish such as your churches website, or registration forms.  You can also easily embed the Bible and small group lessons from <a href="https://lessons.church/">Lesson.church</a>.</p>
